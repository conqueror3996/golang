...
func isDatabaseIsClosedError(err error) bool {
	...
	apllog.Debugf(apllogdefaultutil.LogMessageV1(fmt.Sprintf("adapter/gormdbreadreplica/common.go : isDatabaseIsClosedError : errString=%v", errString)))
...
func isDeadlockError(err error) bool {
	...
	errString := fmt.Sprintf("%v", err)
	apllog.Debugf(apllogdefaultutil.LogMessageV1(fmt.Sprintf("adapter/gormdbreadreplica/common.go : isDeadlockError : errString=%v", errString)))
